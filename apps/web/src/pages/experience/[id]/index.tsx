import { ApiDataResponse, IExperienceRead } from '@my/types';
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  const experience = await serverSideFetch<ApiDataResponse<IExperienceRead>>(
    webEndpointUrls.getExperienceDetail(context?.params?.id as string),
    context.req
  );
  ...
  return (
    <main>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <RichTextRenderer data={parseStringArticle(experience?.article)} />
      ...
      <div className="w-full mb-4">
        <AllCommentTabs
          endPointUrlGetAllComments={webEndpointUrls.experienceCommentsGetAll}
