...
const Experience = ({
  ...
  return (
    <main>
      <MainTitle {...defaultTextsObject} {...defaultImagesObject} />
      <ExperienceTips {...defaultTextsObject} {...defaultImagesObject} />
      <div className="mx-auto max-w-7xl k-container">
        <div className="flex justify-between pb-6 mt-10 border-b border-k-border-2-color">
          <h1 className="text-base font-medium">آخرین تجربیات ثبت شده</h1>
          <Link
