...
const SliderHistory: FC<ISliderHistory> = ({}) => {
	...
	return (
		<div className="relative z-20 py-3 sm:rounded-tr-lg sm:bottom-0 sm:left-0 sm:px-4 sm:py-6 sm:absolute bg-slate-800 sm:w-52">
			<div className="text-center text-k-opposite-text-color sm:flex">
				<div className="w-full">
					<p>{data[activeIndex].label}</p>
					<p className="text-center text-k-primary-color">
