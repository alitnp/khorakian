...
interface ITcDevider {
  className?: string;
  orientation?: string;
  children?: ReactNode;
}

const TcDevider: FC<ITcDevider> = ({ className, orientation = 'right', children, ...props }) => {
  return (
    <div className={`flex items-center  mb-2 ${className ? className : 'mt-8'} `} {...props}>
